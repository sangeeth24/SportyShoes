...
<!-- <body>
    ...
    <div class="copyright">Copyright © 2021 SportyShoes Developer:<span class="text-info"> Sangeeth Rajan</span></div>  
  
              <span class="list-group-item"><strong>Email:</strong> gvsangeethrajan24@gmail.com</span>              
    ...
    <div class="copyright">Copyright © 2021 SportyShoes Developer:<span class="text-info">Sangeeth Rajan</span>
  </div>
  </div> -->
  </body>
</html>